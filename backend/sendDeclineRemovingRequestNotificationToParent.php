<?php
    ...
    && isset($_POST["parentEmail"])){
        ...
        $sql = "SELECT firstname, lastname FROM profile WHERE email = ?";
            ...
            $notificationBody = "$teacherName declined deleting the course, click to show more ..";
        ...
        $stmt->bind_param("sissiii",$parentEmail,$notificationType,$notificationTitle,$notificationBody,$parentSentRequestId,$teacherSentRequestId,$courseId);
        $stmt->execute();
    }
    else {
