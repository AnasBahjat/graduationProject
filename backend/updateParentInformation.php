<?php
    ...
    if(json_last_error() === JSON_ERROR_NONE){
        $insertParent = $conn -> prepare("INSERT INTO parent(email,idNumber) VALUES(?,?);");
        $insertParent->bind_param('ss',$email,$idNumber);
        if($insertParent->execute()){
            ...
            if($insertPhoneResult == "true"){
                ...
                if($insertCildrenResult=="true"){
                    ...
                    $setProfileDone->close();
                    $insertAddressResult = insertParentAddress($email,$city,$country,$conn);
                    if($insertAddressResult == "true"){
                        echo "Done Insertion";
                    }
                    else {
    ...
    function insertParentAddress($email,$city,$country,$conn){
