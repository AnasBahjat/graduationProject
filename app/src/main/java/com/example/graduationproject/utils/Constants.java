...
public class Constants {
    public static String registrationURL = "http://192.168.1.26/graduationProject/registration.php/";
    public static String loginURL = "http://192.168.1.26/graduationProject/login.php";
    public static String checkAccountDoneURL = "http://192.168.1.26/graduationProject/checkAccountDone.php";
    public static String updateTeacherInformation = "http://192.168.1.26/graduationProject/updateTeacherInformation.php";
