...
public class Parent implements Parcelable {
    ...
    public Parent(String email, List<String> phoneNumbersList) {
        this.email = email;
        this.phoneNumbersList = phoneNumbersList;
    }


    public Parent(String email,String firstName,String lastName,List<String> phoneNumbersList,int x){
        this.email=email;
    ...
    public Parent(String email,String firstName,String lastName,List<Address> addressList,List<String> phoneNumbersList){
        this.email=email;
        this.lastName=lastName;
        this.firstName=firstName;
